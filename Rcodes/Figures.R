...
# reading data for all countries.


res_p_lag<-fread(here(here("Data","lifetables","res_all_countries.csv")))
...
#write.table(res_table_main_50, here("Tables","res_table_main_50.csv"), sep=",", row.names = F) # info for building Table 1.
